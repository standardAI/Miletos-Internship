...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        grads['W' + str(self.num_layers)] += 0.5 * 2 * self.reg * self.params['W' + str(self.num_layers)]
        ...
        for i in range(self.num_layers - 1, 0, -1):
            ...
            if self.normalization == 'batchnorm':
                dout, grads['gamma' + str(i)], grads['beta' + str(i)] = batchnorm_backward(dout, caches.pop())
            if self.normalization == 'layernorm':
                dout, grads['gamma' + str(i)], grads['beta' + str(i)] = layernorm_backward(dout, caches.pop())
